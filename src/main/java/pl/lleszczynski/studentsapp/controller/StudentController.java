...
public class StudentController {
   ...
   @GetMapping(value = "/students/{department}")
   public String getStudentByDepartment(Model model,
                                   @PathVariable String department) {
       Student student = student = studentService.findByDepartment(department);
       if (student == null) {
